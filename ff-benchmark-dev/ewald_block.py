...
from ewald_auxiliary.base_layers import Dense, ResidualLayer
from ewald_auxiliary.scale_factor import ScaleFactor
...
class EwaldBlock(torch.nn.Module):
    ...
    def forward(
        ...
        hres = self.pre_residual(h).double()

...
class TrainingConfigPotnet(BaseSettings):
    ...
    cache_dir: str = "cache"
    checkpoint_dir: str = "checkpoints_potnet"
...
class TrainingConfigMatformer(BaseSettings):
    """Training config defaults and validation."""
    ...
    use_save: bool = False
    checkpoint_dir: str = "checkpoints_matformer"
    use_wandb: bool = False
    use_angle: bool = False
    # model configuration
    model: Union[
        MatformerConfig,
    ] = MatformerConfig(name="matformer")
